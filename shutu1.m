...
I_target = imread('D:\文件\数字图像处理\图像识别三级项目\target2.png');          %读入图片
I_template = imread('D:\文件\数字图像处理\图像识别三级项目\template2.png');
...
xuhao = 1:num;
xuhao = string(xuhao');
xlswrite('C:\Users\FENGYIQING\Desktop\图像识别三级项目\第二题第四小问坐标.xlsx',xuhao,'Sheet1','A2');
xlswrite('C:\Users\FENGYIQING\Desktop\图像识别三级项目\第二题第四小问坐标.xlsx',zuoshang,'Sheet1','B2');
xlswrite('C:\Users\FENGYIQING\Desktop\图像识别三级项目\第二题第四小问坐标.xlsx',youshang,'Sheet1','C2');
xlswrite('C:\Users\FENGYIQING\Desktop\图像识别三级项目\第二题第四小问坐标.xlsx',zuoxia,'Sheet1','D2');
xlswrite('C:\Users\FENGYIQING\Desktop\图像识别三级项目\第二题第四小问坐标.xlsx',youxia,'Sheet1','E2');
xlswrite('C:\Users\FENGYIQING\Desktop\图像识别三级项目\第二题第四小问坐标.xlsx',zhongdian,'Sheet1','F2');
